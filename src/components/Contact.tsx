        ...
        <section id="contact" className="relative py-24 min-h-screen flex items-center justify-center overflow-hidden border-b border-[var(--color-brand-dark)]">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full z-10">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                    ...
                    >
                        <form className="bg-[var(--color-brand-dark)]/20 p-8 rounded-2xl glass border border-[var(--color-brand-coffee)]/20 shadow-xl space-y-6" onSubmit={(e) => e.preventDefault()}>
                            ...
                            <button
                                type="submit"
                                className="w-full bg-gradient-to-r from-[var(--color-brand-coffee)] to-[var(--color-brand-coffee-light)] text-white font-semibold py-4 rounded-lg flex items-center justify-center space-x-2 hover:opacity-90 transition-opacity shadow-lg"
                            >
